...
function check_markdown(text) 
 ...
 if msg.content_.ID == "MessageContact" then
	  tabchi.importContacts(msg.content_.contact_.phone_number_, (msg.content_.contact_.first_name_ or '--'), '#JarChi', msg.content_.contact_.user_id_)
        print("ConTact Added")
...
pm = '🙈سیو کردم بیا پیوی '
 ...
 if d:get('joinlink') then
   ...
   tabchi.sendText(msg.chat_id_, msg.id_, 1, '⚙️تنظیمات جارچی \n📨 پیام ذخیره مخاطب :  \n *'..pm..'*\n\n🤖 عضویت خودکار : *'..join..'*\n📲 ذخیره مخاطب : *'..co..'*\n\n', 1, 'md')
        print("Tabchi [ Message ]")
...
if text == 'JarChi' and is_sudo(msg) then
tabchi.sendText(msg.chat_id_, msg.id_, 1,'*JarChi* `is an advertising robot that never gets billed`\n `and you can easily advertise with it`\n *Developer*: @LeeMuTe\n*Power By :* @MrhbT\n*Version*: `2`\n➖➖➖➖➖➖\n( جارچی ) `یک ربات تبلیغاتی است`\n `که هرگز دیلیت اکانت نمیشود`\n `و شما میتوانید به راحتی با آن تبلیغ کنید`\n\n *توسعه دهنده* : @LeeMuTe \nقدرت گرفته از : @Mrhbt \nورژن : 2', 1, 'md')
end
...
tabchi.sendText(msg.chat_id_,msg.id_,1,'*♻️ریلود جارچی با موفقیت انجام شد*',1,'md')
end
